...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var cornerRadius2: CGFloat = 0 {
        didSet {
            tagViews.forEach {
                $0.cornerRadius2 = cornerRadius2
            }
        }
    }
    @IBInspectable open dynamic var borderWidth2: CGFloat = 0 {
        didSet {
            tagViews.forEach {
                $0.borderWidth2 = borderWidth2
            }
        }
    }
    
    @IBInspectable open dynamic var borderColor2: UIColor? {
        didSet {
            tagViews.forEach {
                $0.borderColor2 = borderColor2
            }
        }
    }
    ...
    @IBInspectable open dynamic var paddingY: CGFloat = 25 {
        didSet {
    ...
    @IBInspectable open dynamic var paddingX: CGFloat = 25 {
        didSet {
            defer { rearrangeViews() }
            tagViews.forEach {
                $0.paddingX = paddingX
    ...
    @IBInspectable open dynamic var marginY: CGFloat = 24 {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var marginX: CGFloat = 25 {
        didSet {
            rearrangeViews()
        }
    }
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            tagBackgroundView.layer.shadowPath = UIBezierPath(roundedRect: tagBackgroundView.bounds, cornerRadius: cornerRadius2).cgPath
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        tagView.cornerRadius2 = cornerRadius2
        tagView.borderWidth2 = borderWidth2
        tagView.borderColor2 = borderColor2
