...
extension BrandTblCell:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
...
//            cell.lblType.text = getOBJ.value(forKey: "subcategory_name") as? String ?? ""
        ...
        cell.lblTitle.text =  getOBJ.value(forKey: "brand_name") as? String ?? ""//"\(discount_percent) % off"
        let getdis:String = getOBJ.value(forKey: "description") as? String ?? ""
        cell.lblDes.text = getdis.html2String
//            let getImageURL:String = getOBJ.value(forKey: "image") as? String ?? ""
//        print(getImageURL)
            ...
            if(getimageURl.count > 0)
                   {
                     ...
                     cell.imgProduct.sd_setImage(with: URL(string:getimageURl), placeholderImage: UIImage(named: "noimage"))
                   }else
                   {
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: self.bounds.size.width/3, height: self.collectionAccess.frame.size.height)
