...
class CoursesProfileVC: UIViewController {
...
extension CoursesProfileVC:TagListViewDelegate
{
...
extension CoursesProfileVC:UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        let getlang = getDic.value(forKey: "name") as? String ?? ""
        if(!selectedSkills.contains(getlang))
        {
          self.tagLanguage.addTag(getlang)
            self.selectedSkills.add(getlang)
...
extension CoursesProfileVC:UITextFieldDelegate
{
...
extension CoursesProfileVC
{
    func connection_SearchSkills(getText:String)
    {
       ...
       // Indicator.shared.showProgressView(self.view)
        ...
        print(params)
        print(ConstantsHelper.user_course)
        WebServiceManager.shared.callWebService_NoLoader(ConstantsHelper.user_course, parameters: params, method: .post) { (response: Any, error, errorMessage)  in
            ...
            if(response is NSDictionary)
            {
                ...
                if(status == true)
                {
                    ...
                    }else
                    {
                        ...
                        self.lblNewSkills.text = "+ New Course  '\(getText)' "
                    }
                }else
                {
