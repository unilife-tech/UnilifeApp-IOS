...
class SkillProfileVC: UIViewController {
...
extension SkillProfileVC:TagListViewDelegate
{
...
extension SkillProfileVC:UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblTitle.text = getDic.value(forKey: "skill_name") as? String ?? ""
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        let getlang = getDic.value(forKey: "skill_name") as? String ?? ""
        if(!selectedSkills.contains(getlang))
        {
          self.tagLanguage.addTag(getlang)
            self.selectedSkills.add(getlang)
...
extension SkillProfileVC:UITextFieldDelegate
{
...
extension SkillProfileVC
{
    func connection_SearchSkills(getText:String)
    {
       ...
       // Indicator.shared.showProgressView(self.view)
        ...
        print(params)
        print(ConstantsHelper.user_skills)
        WebServiceManager.shared.callWebService_NoLoader(ConstantsHelper.user_skills, parameters: params, method: .post) { (response: Any, error, errorMessage)  in
            ...
            if(response is NSDictionary)
            {
                ...
                if(status == true)
                {
                    ...
                    }else
                    {
                        ...
                        self.lblNewSkills.text = "+ New Skill  '\(getText)' "
                    }
                }else
                {
