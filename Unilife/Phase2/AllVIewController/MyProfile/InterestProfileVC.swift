...
extension InterestProfileVC:TagListViewDelegate
{
...
extension InterestProfileVC:UITextFieldDelegate
{
...
extension InterestProfileVC
{
    func connection_SearchSkills(getText:String)
    {
       ...
       // Indicator.shared.showProgressView(self.view)
        ...
        WebServiceManager.shared.callWebService_NoLoader(ConstantsHelper.user_interest, parameters: params, method: .post) { (response: Any, error, errorMessage)  in
            ...
            if(response is NSDictionary)
            {
                ...
                if(status == true)
                {
                    ...
                    }else
                    {
                        ...
                        self.lblNewSkills.text = "+ New Intrest  '\(getText)' "
                    }
                }else
                {
    ...
    func connection_AddSkills()
    {
       ...
       // Indicator.shared.showProgressView(self.view)
        ...
        print(params)
        print(ConstantsHelper.user_interest)
        WebServiceManager.shared.callWebService_NoLoader(ConstantsHelper.user_interest, parameters: params, method: .post) { (response: Any, error, errorMessage)  in
