...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @IBInspectable dynamic open var titleColor: UIColor = .appDarKGray {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var lineColor: UIColor = .appDarKGray {
        didSet {
            updateLineView()
        }
    }
    ...
    @IBInspectable dynamic open var selectedLineColor: UIColor = .appDarKGray {
        didSet {
            updateLineView()
        }
    }
    ...
    // Change to set right and left value
    /////////////////////////////////////
    
    @IBInspectable dynamic open var rightPaddingForTitle: CGFloat = 0.0 {
        didSet {
            
        }
    }
    
    @IBInspectable dynamic open var leftPaddingForTitle: CGFloat = 0.0 {
        didSet {
            
        }
    }
    
    @IBInspectable dynamic open var rightPaddingForTextAndPlaceholder: CGFloat = 0.0 {
        didSet {
            
        }
    }
    
    @IBInspectable dynamic open var leftPaddingForTextAndPlaceholder: CGFloat = 0.0 {
        didSet {
            
        }
    }
    
    @IBInspectable dynamic open var bottomPaddingToLine: CGFloat = 0.0 {
        didSet {
    ...
    */
    ...
    fileprivate func configureDefaultLineHeight() {
        ...
        lineHeight = 0.5 //1.0 * onePixel
        selectedLineHeight = 1.0 //* self.lineHeight
    }
    ...
    */
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        let rect = CGRect(
            x: superRect.origin.x + self.leftPaddingForTextAndPlaceholder,
            y: titleHeight,
            width: superRect.size.width - (self.leftPaddingForTextAndPlaceholder + self.rightPaddingForTextAndPlaceholder),
    ...
    override open func placeholderRect(forBounds bounds: CGRect) -> CGRect {
        let rect = CGRect(
            x: self.leftPaddingForTextAndPlaceholder,
            y: titleHeight(),
            width: bounds.size.width - (self.leftPaddingForTextAndPlaceholder + self.rightPaddingForTextAndPlaceholder),
    ...
    */
    open func titleLabelRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        if editing {
            return CGRect(x: self.leftPaddingForTitle, y: 0, width: bounds.size.width - (self.leftPaddingForTitle + self.rightPaddingForTitle), height: titleHeight())
        }
        return CGRect(x: self.leftPaddingForTitle, y: titleHeight(), width: bounds.size.width - (self.leftPaddingForTitle + self.rightPaddingForTitle), height: titleHeight())
    }
    ...
    open func lineViewRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        ...
        return CGRect(x: 0, y: bounds.size.height - height + self.bottomPaddingToLine, width: bounds.size.width, height: height)
    }
